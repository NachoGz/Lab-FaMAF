...
public class Config {
    ...
    public Config(boolean printFeed, boolean computeNamedEntities, String feedKey, boolean printHelp,
            ...
            String heuristicKey, String statsFormatKey, String sparkKey) {
    ...
    public void printHelp(List<FeedsData> feedsDataArray) {
        ...
        System.out.println("  -s, --spark <file>:                  Specify a specific text file to compute with Spark");
    }
